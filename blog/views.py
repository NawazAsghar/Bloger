...
class Signup(FormView):
    ...
    form_class = RegistertionForm
    success_url = '/createProfile/'
    extra_context = {'signup':'active'}
    def form_valid(self, form):
        if form.is_valid():
            newUser = form.save()
...
# __________________________to get data from model______________________________________________________.
